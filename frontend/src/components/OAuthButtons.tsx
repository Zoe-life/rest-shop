    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 gap-3">
        ...
        <button
          ...
          className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-navy-600 rounded-lg shadow-sm bg-black dark:bg-white text-sm font-medium text-white dark:text-black hover:bg-gray-900 dark:hover:bg-gray-100 transition-colors"
        >
